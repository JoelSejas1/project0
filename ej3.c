...
int main(void)
{
    ...
    // USR_SW2 está en el PIN 1 del Puerto J
    ...
    while(1)
    {
        // Usamos 0 porque el WPU (Pull-up) pone el pin en 1 y el botón lo baja a 0
